...
namespace ViClass.Models.UploadVideo.Data
{
    public class Session
    {
        ...
        public Session(string user, FileInformation fileInfo) : this(user, fileInfo, DEFAULT_TIMEOUT)
        {

        }

        public Session(string user, FileInformation fileInformation, long timeout)
        {
